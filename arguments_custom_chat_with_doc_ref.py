...
gcgroup.add_argument("-g", "--gpu", action="store_true")
gcgroup.add_argument("-c", "--cpu", action="store_true")
...
parser.add_argument("-i","--instrmodel", type=str, default='hkunlp/instructor-xl', help="Set the name of the instruct model. Default: hkunlp/instructor-xl")
